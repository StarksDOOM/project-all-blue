# Project All Blue — FastAPI Backend Guidelines
...
## Commands
- Run all backend tests: `cd apps/api-fastapi; .\.venv\Scripts\python.exe -m pytest`
- Run specific test file: `cd apps/api-fastapi; .\.venv\Scripts\python.exe -m pytest tests/test_filename.py`
