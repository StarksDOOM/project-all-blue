...
| [api/internal-leads-crm.spec.md](specs/api/internal-leads-crm.spec.md) | STREAM 6 PHASE 1.7.1 | DRAFT |
...
STREAM 6 — Contract automation & signing
  ...
  PHASE 1.7.1 internal-leads-crm (GET /api/v1/leads paginated endpoint, LeadsDataGrid agent dashboard) [DRAFT; baseline 18]
```
